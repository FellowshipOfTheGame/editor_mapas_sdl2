...
View::View() {
   ...
   //Initialize SDL
    ...
    //Create this->window
    this->window = SDL_CreateWindow("Editor de Mapas", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, WIDTH, HEIGHT+20, SDL_WINDOW_SHOWN);
    if (this->window == NULL) {
